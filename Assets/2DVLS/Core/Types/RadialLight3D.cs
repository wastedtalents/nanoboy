...
public class RadialLight3D : Light2D
{
    ...
    protected override void CollectColliders()
    {
        ...
        //Physics.CheckCapsule(pos + new Vector3(), pos - new Vector3(), );
    ...
    public static RadialLight3D Create(Vector3 _position, Color _color, float _radius = 1, float _coneAngle = 360, float _coneStart = 0, Material _material = null)
    {
        GameObject obj = new GameObject("RadialLight");
        obj.transform.position = _position;

        RadialLight3D l = obj.AddComponent<RadialLight3D>();
